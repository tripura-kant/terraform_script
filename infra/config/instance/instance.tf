module "compute_instance_sonarqube" {
  source     = "git::https://source.developers.google.com/p/infgprj-gss-n-iacbst-gl-01/r/infgrep-gss-iac-mod-npr-01//modules/compute-instance/"
  ...
  service_account = {
    email  = "test-terraform-sonarqube@infgprj-gss-n-iacbst-gl-01.iam.gserviceaccount.com"
